...
import com.tiagosilva.crudDeCliente.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<ClienteDomain> find(@RequestParam(value = "value") String email) {
		ClienteDomain obj = service.findByEmail(email);
